                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="preview mt-2">
                                                    <img src="{{ asset('upload/images/settings/' . $profile->logo) }}" id="file-ip-1-preview" width="200px">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @enderror
                                                <div class="preview mt-2">
                                                    <img src="{{ asset('upload/images/settings/' . $profile->footer_logo) }}" id="file-ip-2-preview" width="200px">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @enderror
                                                <div class="preview mt-2">
                                                    <img src="{{ asset('upload/images/settings/' . $profile->favicon) }}" id="file-ip-3-preview" width="200px">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @enderror
                                                <div class="preview mt-2">
                                                    <img src="{{ asset('upload/images/settings/' . $profile->image) }}" id="file-ip-4-preview" width="200px">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="introduction">प्रतिष्ठानको परिचय</label>
                                                <textarea type="text" name="introduction" class="summernote" placeholder="प्रतिष्ठानको परिचय">{{ $profile->introduction }}</textarea>
                                                @error('introduction')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="file-ip-5" accept="image/*"
                                                    class="form-control-file border" value="{{ old('objective_image') }}"
                                                    onchange="showPreview5(event);" name="objective_image">
                                                @error('objective_image')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="preview mt-2">
                                                <img src="{{ asset('upload/images/settings/' . $profile->objective_image) }}" id="file-ip-5-preview" width="200px">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="objective">उद्देश्य</label>
                                                <textarea type="text" name="objective" class="summernote" placeholder="उद्देश्य">{{ $profile->objective }}</textarea>
                                                @error('objective')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="work_limit">कार्यसमिति</label>
                                                <textarea type="text" name="work_limit" class="summernote" placeholder="कार्यसमिति">{{ $profile->work_limit }}</textarea>
                                                @error('work_limit')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="management">व्यबस्थापन</label>
                                                <textarea type="text" name="management" class="summernote" placeholder="व्यबस्थापन">{{ $profile->management }}</textarea>
                                                @error('management')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="main_task">मुख्यकार्य</label>
                                                <textarea type="text" name="main_task" class="summernote" placeholder="मुख्यकार्य">{{ $profile->main_task }}</textarea>
                                                @error('main_task')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name='meta_keywords' class="form-control" placeholder='Keywords'>{{ $profile->meta_keywords }}</textarea>
                                                @error('meta_keywords')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
