...
class CompanyProfileController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            $filename=$request->objective_image->getClientOriginalName();
            $objective_image = time().$filename;

            $request->objective_image->move(public_path('upload/images/settings'), $objective_image);

        }
        else{
            $objective_image = $profile->objective_image;
        }
