...
class MenuController extends Controller
{
    ...
    {
        abort_if(Gate::denies('show_menu'), 403);
    ...
    {
        abort_if(Gate::denies('create_menu'), 403);
    ...
    {
        abort_if(Gate::denies('edit_menu'), 403);
        $pages = Page::where('status','on')->latest()->get();
        $menus = Menu::where('parent_id',Null)->where('status','on')->latest()->get();
    ...
    {
        abort_if(Gate::denies('delete_menu'), 403);
    ...
    {
        abort_if(Gate::denies('access_menu'), 403);
