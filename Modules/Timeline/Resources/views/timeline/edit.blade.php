              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Update Timeline</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="product-form" action="{{ route('timelines.update',$timeline->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="year" class="form-control"
                                        placeholder="Enter Year " value="{{ $timeline->year }}" required>
                                    @error('year')
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Enter Title " value="{{$timeline->title}}" required>
                                    @error('title')
                                    <p style="color: red">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('upload/images/timelines/'.$timeline->image) }}" alt="{{ $timeline->title }}" width="200px">
                                    @error('image')
                                            <p style="color: red">{{ $message }}</p>
                                        @enderror
